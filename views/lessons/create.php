    ...
    <section class='w-1/2'>
        <form method="POST" enctype="multipart/form-data" action="/lessons/create">
            <div class="mt-6 grid gap-4 lg:gap-6">
                ...
                <select name="category" class="py-3 px-4 border pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none ">
                ...
                <div>
                    ...
                    <textarea type="text" name="description" rows="4" required value='<?php echo  $description ?>' class="py-3 px-4  border block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 
                focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none ">
